...
![Exponential likelihood with a Gamma prior](images/c1l09-ss-01-exponential-data.png){#fig-exponential-likelihood-gamma-prior .column-margin width="200px" group="slides"}
...
[Time between buses]{.column-margin}
