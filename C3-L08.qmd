...
## Computational Considerations (Video)

![Computational Considerations](images/c3l5-ss-01-numerical-stability.png){#fig-s01-numerical-stability .column-margin width="200px"}
...
### Sample code to illustrate numerical stability issues (Reading)
...
### Computational issues associated with multimodality (Video) {#sec-computational-issues}

![multimodality issues](images/c3l5-ss-02-multimodality.png){#fig-s02-multimodality .column-margin width="200px"}




### Sample code to illustrate multimodality issues 1 (Reading) {#sec-multimodality-1}
...
### Sample code to illustrate multimodality issues 2 (Reading) {#sec-multimodality-2}
