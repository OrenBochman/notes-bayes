---
title : 'M5L8 - Computational Considerations'
...
![Computational Considerations](images/c3l5-ss-01-numerical-stability.png){.column-margin width="200px"}
...
### Computational issues associated with multimodality (Video)

![multimodality issues](images/c3l5-ss-02-multimodality.png){.column-margin width="200px"}


### Sample code to illustrate multimodality issues 1 (Reading)
...
### Sample code to illustrate multimodality issues 2 (Reading)
