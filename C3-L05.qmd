...
::: {#exr-1}
Let $K^*$ be the prior expected number of occupied components in a mixture model with $K$ components where the weights are given a Dirichlet prior $(w_1,…,w_K)∼Dir(2/K,…,2/K)$.  If you have $n=400$ observations, what is the expected number of occupied components, $E(K^*)$ according to the **exact** formula we discussed in the lecture?  Round your answer to one decimal place.
:::
