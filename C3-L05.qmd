...
## Density Estimation using Mixture Models (Video) {#sec-density-estimation-using-mixture-models}
...
### Density Estimation Example (Video) {#sec-density-estimation-example}
