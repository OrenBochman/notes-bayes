...
::: {#exr-dic-1}
[DIC]{.colum-margin} What is the primary interpretation of the penalty term in the deviance information criterion (DIC)?
:::
...
::: {#exr-dic-2}
[DIC]{.colum-margin} DIC is a helpful tool for selecting among competing models. Which of the following changes to a linear model is not appropriate to evaluate with DIC?
:::
...
```{r}
#| label: mcmc diagnostics for mod2
#| fig-width: 7
#| fig-height: 8
plot(mod2_sim)
```
...
::: {#exr-dic-5}
[DIC]{.colum-margin} Using the model favored by the DIC, obtain a Monte Carlo estimate of the posterior probability that the coefficient for income is positive (greater than 0.0). Round your answer to two decimal places.
:::
...
::: {#exr-dic-6}
[convergence]{.colum-margin} Which of the following accurately summarizes our conclusions based on the model favored by the DIC?
:::
