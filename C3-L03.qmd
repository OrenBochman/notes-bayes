...
## EM algorithms for general mixtures 🎥 {#sec-EM-algorithm-for-general-mixtures}
...
## EM for location Mixture of Gaussians 🎥  {#sec-em-for-location-mixtures-of-gaussians}
...
## EM example 2 🎥 {#sec-em-example-2}

This video covers the code sample given in @sec-sec-multivariate-EM below. It is a more advanced implementation of the EM algorithm for fitting a mixture of multivariate Gaussian components to simulated data.
