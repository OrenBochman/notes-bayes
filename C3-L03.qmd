...
# The EM algorithm for Mixture Models (Video){#sec-em-algorithm-for-mixture-models}
...
![EM - Challenge](images/c3l2-ss-01-em-for-general-mixtures.png){.column-margin width="200px"}



![EM - Steps](images/c3l2-ss-02-em-for-general-mixtures.png){.column-margin width="200px"}



![EM - Deep Dive](images/c3l2-ss-03-em-for-general-mixtures.png){.column-margin width="200px"}
...
![the responsibility](images/c3l2-ss-04-em-for-location-mixtures-of-gaussians.png){.column-margin width="200px"}




![the derivative of Q wrt to w](images/c3l2-ss-05-em-for-location-mixtures-of-gaussians.png){.column-margin width="200px"}




![the derivative of Q wrt to mu](images/c3l2-ss-06-em-for-location-mixtures-of-gaussians.png){.column-margin width="200px"}




![the derivative of Q wrt to sigma](images/c3l2-ss-07-em-for-location-mixtures-of-gaussians.png){.column-margin width="200px"}
...
## Sample code for EM example 1 {#sec-em-code-example-1}
