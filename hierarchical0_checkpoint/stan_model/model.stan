...
transformed parameters {
  ...
  r_3_1 = r_3[, 1];
  r_3_2 = r_3[, 2];
  lprior += student_t_lpdf(Intercept | 3, 125950, 27798.8);
  lprior += student_t_lpdf(sigma | 3, 0, 27798.8)
    - 1 * student_t_lccdf(0 | 3, 0, 27798.8);
  lprior += student_t_lpdf(sd_1 | 3, 0, 27798.8)
    - 2 * student_t_lccdf(0 | 3, 0, 27798.8);
  lprior += lkj_corr_cholesky_lpdf(L_1 | 1);
  lprior += student_t_lpdf(sd_2 | 3, 0, 27798.8)
    - 2 * student_t_lccdf(0 | 3, 0, 27798.8);
  lprior += lkj_corr_cholesky_lpdf(L_2 | 1);
  lprior += student_t_lpdf(sd_3 | 3, 0, 27798.8)
    - 2 * student_t_lccdf(0 | 3, 0, 27798.8);
