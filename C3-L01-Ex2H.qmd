...
```{r}
# Modify code to Generate n observations from a mixture of two Gaussian # distributions
# into code to sample 100 random numbers from a mixture of 4 exponential distributions with means 1, 4, 7 and 10 and weights 0.3, 0.25, 0.25 and 0.2, respectively. 
