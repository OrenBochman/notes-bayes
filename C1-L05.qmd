...
![coin probability inference](images/c1l05-ss-01-inference-example-frequentist.png){.column-margin}
...
![coin probability inference](images/c1l05-ss-02-inference-example-bayesian.png){.column-margin}
...
![Continuous version of Bayes' theorem](images/c1l05-ss-03-continuous-bayes-theorem.png){.column-margin}

## Posterior Intervals {#sec-posterior-intervals}

![Posterior Intervals](images/c1l05-ss-04-posterior-intervals.png){.column-margin} \## Discussion CIs
...
-   A Bayesian CI might be better if:
    ...
    2.  I care about the parameter's value and less about hypothesis testing
    3.  I need an estimate of uncertainty for the parameter and the inference it is used in.
    4.  I had subjective reasons to introduce a prior
        -   I know about constraints
        -   I have access to expert knowledge
    5.  I wish to introduce pooling between groups
    6.  My results are in a Baysian-oriented domain.
:::
