...
::: {#exr-mh-1}
[M-H]{.colum-margin} In which situation would we choose to use a Metropolis-Hastings (or any MCMC) sampler rather than straightforward Monte Carlo sampling?
:::
...
-   [ ] ![q=Exp(0.1)](images/AEEy5Ol_EeaU0gpeZEyzfg_211f991f99097baa24920c549400eb1a_ex2_d.svg)
...
::: {#exr-mh-3}
[M-H]{.colum-margin} If we employed an independent Metropolis-Hastings algorithm (in which the candidate-generating distribution q does not depend on the previous iteration of the chain), what would happen if we skipped the acceptance ratio step and always accepted candidate draws?
:::
