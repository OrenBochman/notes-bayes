---
title: "M1L2HW2 - Probability and Bayes' Theorem"
...
::: {#exr-honor1-9}
Show that the two expressions for independence $\mathbb{P}r(A∣B)=\mathbb{P}r(A)$ and $\mathbb{P}r(A∩B) = \mathbb{P}r(A)\mathbb{P}r(B)$ are equivalent.
:::
