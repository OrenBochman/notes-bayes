...
![Gibbs sampler](images/c2l05-fig-01-Gibbs-sampler.jpg){.column-margin}
...
![Multiple parameter sampling and full conditional distributions](images/c2l05-ss-02-Multiple-parameter-sampling-and-full-conditional-distributions.png){.column-margin}
...
![Normal likelihood, unknown mean and variance](images/c2l05-ss-03-conditionally-conjugate-prior-example-with-Normal-likelihood.png){.column-margin}
...
![Normal likelihood conjugate prior](images/c2l05-ss-04-conditionally-conjugate-prior-example-with-Normal-likelihood.png){.column-margin}
