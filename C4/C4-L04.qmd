...
{{< include transcripts/c4/02_week-2-the-ar-p-process/01_the-general-ar-p-process/01_definition-and-state-space-representation.en.txt >}}
...
* **Three root types**:
  ...
  2. **Two complex conjugate reciprocal roots**: Let roots be $r e^{\pm i\omega}\$.
     Forecast function:
...
{{< include transcripts/c4/02_week-2-the-ar-p-process/01_the-general-ar-p-process/02_examples.en.txt >}}
...
{{< include transcripts/c4/02_week-2-the-ar-p-process/01_the-general-ar-p-process/03_acf-of-the-ar-p.en.txt >}}
...
```{r}
#| label: lst-compute-ar-p-reciprocal-roots
#| list-label: lst-compute-ar-p-reciprocal-roots
#| list-caption: Compute AR reciprocal roots given the AR coefficients
...
{{< include transcripts/c4/02_week-2-the-ar-p-process/01_the-general-ar-p-process/04_simulating-data-from-an-ar-p.en.txt >}}
