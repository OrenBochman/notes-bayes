---
date: 2024-11-09
title: "Practice Graded Assignment: NDLM data analysis"
...
- requires R packages `gtrends`,and `dlm` as well as the files     
   - "all_dlm_functions_unknown_v.R" and
   - "discountfactor_selection_functions.R" 
  also provided below. 
...
write.csv(ts, "google_trends_timeseries.csv", row.names = FALSE)
...
loaded_csv <- read.csv("google_trends_timeseries.csv",stringsAsFactors = FALSE)
