...
![conditional probability](images/c1l02-ss-01-conditional-probability.png){#fig-conditional-probability .column-margin width="200px"}
...
## Bayes' theorem (Video) {#sec-bayes-theorem-video}
...
![mutually exclusive events](images/total-probability.jpg){#fig-mutually-exclusive-events .column-margin width="200px"}
...
$$
\begin{aligned} P(H_1 \mid E) 
  & = \frac{P(E \mid H)P(H_1)}{P(E \mid H_1)P(H_1) +\ldots  + P(E \mid H_n)P(H_N)} \\ 
  & = \frac{P(E \mid H)P(H_1)}{\sum_{i=1}^{N} P(E \mid H_i)P(H_i)} \end{aligned}
$$
...
![Rev. Thomas Bayes by Mark Riehl](images/bio-Thomas-Bayes.png){#fig-bio-thomas-bayes .column-margin width="200px"}
