...
![frequentist approach to confidence intervals](images/c1l04-ss-01-confidence-intervals.png){#fig-frequentist-ci .column-margin width="200px"}
...
![Likelihood fn and MLE](images/c1l04-ss-02-Likelihood-fn-and-MLE.png){#fig-likelihood-fn-and-mle .column-margin width="200px"}
...
![Computing the MLE](images/c1l04-ss-03-computing-the-MLE.png){#fig-computing-the-mle .column-margin width="200px"}
...
![computing the MLE for Exponential RV](images/c1l04-ss-04-computing-the-exponential-MLE.png){#fig-computing-the-MLE-for-exponential-rv .column-margin width="200px"}
...
![computing the MLE for Uniform RV](images/c1l04-ss-05-computing-the-uniform-MLE.png){#fig-computing-the-MLE-for-uniform-RV .column-margin width="200px"}
...
![Illustration of using the CDF to calculate the probability of an interval for continuous random variable X. Probability values are represented with shaded regions in the graphs.](images/c1l04-ss-06-CDF.png){#fig-interval-from-cdf fig-alt="using the CDF to calculate the probability of an interval" width="200px"}
