...
The amount of time we have to wait for α  arrivals of a Poisson process. More concretely, if we have events, $X_1 , X_2 , \ldots, X_α$ that are exponentially distributed, $X_1+X_2+dots+X_α$  is Gamma distributed.
