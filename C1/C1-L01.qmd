...
keywords: [Odds, Probability, Expectation, σ-Algebra, Probability Measure, Probability Space, Probability Paradigms, Coherence, Abraham de Moivre, Bruno de Finetti, Objectivity, Variance, Covariance, Correlation]
---

## Rules of Probability, Odds & Expectation {#sec-rules-of-probability-odds--expectation}

::: {.column-margin}
![Background reading](/handouts/c1l01-rules-of-probability.pdf){#fig-rules-of-probability .lightbox group="figures" width="100%" height="800px"}
:::

@fig-rules-of-probability reviews the rules of probability, odds, and expectation.
...
-   [Difference between topology and sigma-algebra axioms](https://math.stackexchange.com/questions/1330649/difference-between-topology-and-sigma-algebra-axioms)
-   [An epsilon of room: pages from year three of a mathematical blog](https://terrytao.files.wordpress.com/2010/02/epsilon.pdf) § 2.7
...
::: {.column-margin}
![Illustration of a probability space by Ziggystar](/images/Probability-measure.svg.png){#fig-probability-space width="100%" height="auto" group="figures"}
:::
...
::: {.column-margin}
![Never tell me the odds - Meme](/images/c1/Never.webp){#fig-never-tell-me-the-odds group="figures" width="100%" height="auto"}

> [C-3PO]{.marked}: Sir, the possibility of successfully navigating an asteroid field is approximately 3,720 to 1! <br>
> [Han Solo]{.marked}: Never tell me the odds! --- Star Wars Episode V: The Empire Strikes Back
:::

Another *mental model* for thinking about probabilities is using *odds* [@eq-odds]. 
[Odds are more intuitive when we are thinking about the risk of an event happening or not happening.]{.marked} 
When we consider the risk associated with uncertainty odds are a handy way of considering the risks.
...
::: {#fig-liberty-head-nickel .column-margin width="53mm"}
![Liberty Head nickel](/images/c1/1882_5C_Liberty_Head_Five_Cents_(Judd-1684).jpg)

Recent sales of a 1913 Liberty Head nickel were in April 2013 for more than $3.1 million and for $4.5 million at auction in August 2018.^[Image courtesy of Heritage Auctions, Public domain, via Wikimedia Commons]
:::

::: {#exm-tutubalin-problem}
### Tutubalin’s Problem. 

In a desk drawer in the house of Mr Jay Parrino of Kansas City there is a coin, 1913 Liberty Head nickel. 
What is the probability that the coin is heads up?
:::

The symmetry of the coin problem naturally leads to the conclusion that the probability of heads is 0.5. 
This is a simple example of classical probability, which deals primarily with cases where probabilities are distributed equally, like with dice and cards.
:::
