...
Using the [central limit theorem](/A/A08.qmd) as an approximation, and following the example of [Lesson 4.1](C1-L04.qmd), construct a 95% confidence interval for p, the probability of obtaining heads.
