...
For Questions (@exr-fmle-1 --- @exr-fmle-3), consider the following scenario:
...
#### Solution:
The likelihood is based on the sampling distribution of the data, given the parameter. Note that although the likelihood has the same functional form as $P(y\mid\theta)$, it is considered a function of $\theta$.
