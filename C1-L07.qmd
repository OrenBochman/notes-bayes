...
![Binomial likelihood with a Uniform prior](images/c1l07-ss-01-binomial-likelihood-uniform-prior.png){#fig-binomial-likelihood-uniform-prior .column-margin}
...
![Conjugate Priors](images/c1l07-ss-03-conjugate-priors.png){.column-margin}
...
![Effective Sample Size](images/c1l07-ss-04-effective-sample-size.png){.column-margin}
...
- meteorological and satellites for the last 200 years. ![200 year meterological record](images/20200324_Global_average_temperature_-_NASA-GISS_HadCrut_NOAA_Japan_BerkeleyE.svg){.column-margin}

- ice cores for the last 800,000 years ![800K year ice core record](images/EPICA_temperature_plot.svg){.column-margin}
