...
5.  Suppose the first student gets 33 questions right. What is the posterior distribution for $\theta_1$ ? $\mathbb{P}r(\theta > 0.25)$ ? $\mathbb{P}r(\theta > 0.5)$ ? $\mathbb{P}r(\theta > 0.8)$ ? What is the 95% posterior credible interval for $\theta_1$? 
