...
## Stationarity the ACF and the PACF 🎥 {#sec-stationarity-acf-pacf}
...
### The auto-correlation function ACF 🎥 {#sec-acf}
...
### The partial auto-correlation function PACF 📖 {#sec-pacf-reading}
...
## Differencing and smoothing 📖 {#sec-differencing-and-smoothing}
...
## ACF PACF Differencing and Smoothing Examples 🎥 {#sec-differencing-and-smoothing-examples}

This video walks us through the code snippets in @fig-moving-averages-and-differencing and @lst-white-noise-simulation below and provides examples of how to compute the ACF and PACF of a time series, how to use differencing to remove trends, and how to use moving averages to remove seasonality.
...
## R code for Differencing and filtering via moving averages 📖 {#sec-differencing-and-smoothing-reading}
...
#| fig-cap: "R code: for Differencing and filtering via moving averages"
#| fig.height: 9
#| fig.width: 7
...
## R Code: Simulate data from a white noise process 📖 {#sec-white-noise-simulation}
...
#| lst-cap: "Simulate data with no temporal structure (white noise)"
#| fig.height: 9
#| fig.width: 7
#| 
set.seed(2021)
...
2. Plot the simulated time series, their sample ACF and their sample PACF
