---
date: 2024-11-01
title: "Stationarity, The ACF and the PCF"
...
-   [x] Define **auto-correlation function** (ACF) and
-   [x] Define **partial auto-correlation function** (PACF)
-   [x] use R to plot the sample ACF and sample PACF of a time series
...
{{< include transcripts/c4/01_week-1-introduction-to-time-series-and-the-ar-1-process/02_stationarity-the-acf-and-the-pacf/01_stationarity.en.txt >}}
...
{{< include transcripts/c4/01_week-1-introduction-to-time-series-and-the-ar-1-process/02_stationarity-the-acf-and-the-pacf/02_the-autocorrelation-function-acf.en.txt >}}
...
{{< include transcripts/c4/01_week-1-introduction-to-time-series-and-the-ar-1-process/02_stationarity-the-acf-and-the-pacf/05_acf-pacf-differencing-and-smoothing-examples.en.txt >}}
