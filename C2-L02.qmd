...
![Components of a Bayesian Model](images/c2l02-ss-02.png){.column-margin width="200px"}
...
![Model specification](images/c2l02-ss-05.png){.column-margin} Before fitting any model we first need to specify all of its components.
