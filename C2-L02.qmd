...
![a Bayesian Model](images/c2l02-ss-01.png){.column-margin}
...
![Components of a Bayesian Model](images/c2l02-ss-02.png){.column-margin}
...
![Posterior derivation](images/c2l02-ss-04.png){.column-margin}
...
![Non-conjugate models](images/c2l02-ss-03.png){.column-margin}

We'll first look at an example of a one parameter model that is not conjugate.

::: {#exp-company-personel}
#### Company Personnel
