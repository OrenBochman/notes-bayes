...
![a Bayesian Model](images/c2l02-ss-01.png){.column-margin width="200px"}
...
![Components of a Bayesian Model](images/c2l02-ss-02.png){#fig-heights-of-men .column-margin width="200px"}
...
![Model specification](images/c2l02-ss-05.png){.column-margin width="200px"} 
...
The prior for $\sigma^2$ will be inverse gamma [$\sigma^2 \sim IG(\nu_0,\beta_0)$]{.column-margin} which has two parameters:
...
![Posterior derivation](images/c2l02-ss-04.png){.column-margin width="200px"}
...
![Non-conjugate models](images/c2l02-ss-03.png){.column-margin width="200px"}
