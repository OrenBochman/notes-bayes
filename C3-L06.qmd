...
![Clustering Mixture Models](images/c3l04-ss-01-clustering.png){.column-margin width="53mm" group="slides"}


![Clustering Mixture Models](images/c3l04-ss-02-clustering.png){.column-margin width="53mm" group="slides"}

![Clustering Mixture Models](images/c3l04-ss-03-clustering.png){.column-margin width="53mm"}

![Clustering Mixture Models](images/c3l04-ss-04-clustering.png){.column-margin width="53mm"}


## Clustering example {#sec-clustering-example}
