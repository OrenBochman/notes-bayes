...
The general case wasn't covered in the video and we didn't have a proper statement of the superposition principle.
...
with $F_t$, $G_t$, $v_t$, and $W_t$ known. We also assume a prior distribution of the form $(\theta_0 \mid D_0) \sim  \mathcal{N}(m_0, C_0)$, with $m_0$, $C_0$ known.
...
$$
y_t = F_t' \theta_t + \nu_t, \quad \nu_t \sim  \mathcal{N}(0, v_t), \tag{1}
$$

$$
\theta_t = G_t \theta_{t-1} + \omega_t, \quad \omega_t \sim  \mathcal{N}(0, W_t), \tag{2}
$$

with $F_t$, $G_t$, $v_t$, and $W_t$ known. We also assume a prior distribution of the form $(\theta_0 \mid D_0) \sim  \mathcal{N}(m_0, C_0)$, with $m_0$ and $C_0$ known.
