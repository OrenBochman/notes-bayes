...
![deriving the Prior and Forecast at Time t](images/m3_0041.png){.column-margin width="250px" group="slides"}

![deriving the Posterior at Time t](images/m3_0042.png){.column-margin width="250px" group="slides"}
...
3. Posterior at Time $t$ 
  ...
  These can be derived using Normal theory or via Bayes' theorem. Both are shown in [@west2013bayesian]
