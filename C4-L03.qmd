...
<!-- 
The challange in taking notes in this courses is that the instructors speak out the maths as they go along. I supply the math but I want to extract the non-math parts and put them in the right place. 
-->
...
where $k_{t,0} = E(\beta_{t,0} \mid \mathcal{D}_t)$ and $k_{t,1} = E(\beta_{t,1} \mid \mathcal{D}_t)$.
