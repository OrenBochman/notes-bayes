...
Prado snuck the Moore-Penrose pseudoinverse in this handout, then she used it in the class and notes. I'm thinking this isn't the first time this has come up in the specialization we used MLE to some degree in all the courses, and in depth in the previous course on mixtures.
