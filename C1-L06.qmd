...
Suppose we chose a prior that says the probability of $P(\theta = \frac{1}{2}) = \delta( \frac{1}{2})= 1$
...
Suppose we have an experiment with events based on two RVs: - (C) a coin toss - (D) and a dice toss. And we call this event X = P(C,D) = P(C) \times P(D)

| C D  | 1    | 2    | 3    | 4    | 5    | 6    | p(C) |
|------|------|------|------|------|------|------|------|
| H    | 1/12 | 1/12 | 1/12 | 1/12 | 1/12 | 1/12 | 6/12 |
| T    | 1/12 | 1/12 | 1/12 | 1/12 | 1/12 | 1/12 | 6/12 |
| P(D) | 2/12 | 2/12 | 2/12 | 2/12 | 2/12 | 2/12 | 1    |
