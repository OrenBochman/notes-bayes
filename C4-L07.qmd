...
## R code: Smoothing in the NDLM, Example 📖 {#sec-smoothing-in-the-NDLM}
...
## Second order polynomial: Filtering and smoothing example 🎥 {#sec-second-order-polynomial}
...
## R code: Using the `dlm` package in R 📖 {#sec-dlm-package}
