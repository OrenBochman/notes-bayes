...
![Doing Bayesian Data Analysis](images/book-DBA.jpg){#fig-DBA .column-margin width="150px"}
...
- This text is is recommended for further reading in the course 2 but with the causion that a solid background in calculus-based probability is useful, as many details are left to the reader.

- This text is recommended for further reading in the course 2

![The BUGS book](images/book-BUGS.png){#fig-BUGS .column-margin width="150px"}
...
![Time Series: Modeling, Computation, and Inference](images/book-TSMCI.jpg){#fig-TSMCI .column-margin width="150px"}

[@prado2023time] [Time Series: Modeling, Computation, and Inference](https://www.routledge.com/Time-Series-Modeling-Computation-and-Inference-Second-Edition/Prado-Ferreira-West/p/book/9781032040042?srsltid=AfmBOoodi-xrmkceGPPFHNhIQHiiLpaXEgd8fi2kdG7WNb-w1gYvWe4-) by course instructor Raquel Prado. This book, now in its second edition is a comprehensive introduction to time series analysis and covers a wide range of topics in time series modeling, computation, and inference. The book is suitable for graduate students and researchers in statistics, computer science, and related fields. 

While learning this course I found some of the material harder to follow than I expected. The books helped to clarify definitions and so on however the book is  rather comprehensive and mathematically advanced unlike some other books on statistics. 
...
![Bayesian Forecasting and Dynamic Models](images/book-BFADM.png){#fig-BFADM .column-margin width="150px"}
...
![Practical Times Series Analysis](images/book-PTSA.jpg){#fig-PTSA .column-margin width="150px"}
...
![Bayesian Modeling and Computation in Python](images/book-BMCP.jpg){.column-margin width="150px" }
...
![Bayesian Data Analysis](images/book-BDA.jpg){.column-margin width="150px" }
...
Although this is not a time series book, the authors have been interested in the domain of political election prediction and have used time series data in their research and some of that is covered in the book's examples.

- Audience: The book is suitable for graduate students and researchers in statistics, computer science, and related fields.
- An electronic version of the third edition book is available at [Bayesian Data Analysis](http://www.stat.columbia.edu/~gelman/book/)
...
![Introductory Time Series with R](images/book-ITSWR.jpg){.column-margin width="150px" }


[@cowpertwait2009introductory] "Introductory Time Series with R" by Cowpertwait and Metcalfe, and the second is 
...
![Bayesian Inference for Stochastic Processes by Lyle D. Broemeling](images/book-BIFSP.jpg){.column-margin width="150px" style="vertical-align: top;"  }
...
### Statistics for Spatio-Temporal Data
 ...
 ![Statistics for Spatio-Temporal Data](images/book-SFSTD.jpg){.column-margin width="150px" style="vertical-align: top;"  }
