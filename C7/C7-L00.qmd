---
date: 2026-02-02
subtitle: "Bayesian Statistics - Optimization"
description: "Short course on Bayesian Optimization"
categories:
  - Bayesian Statistics
...
1. [@garnett_bayesoptbook_2023] Bayesian Optimization 
2. [@nguyen2024bayesian] Bayesian Optimization in Action

## Libraries

- [GPyTorch](https://gpytorch.ai/) - A Gaussian Process library implemented in PyTorch.
- [BoTorch](https://botorch.org/) - A library for Bayesian optimization built on top of GPyTorch and PyTorch.
- [scikit-optimize](https://scikit-optimize.github.io/) - A simple and efficient library for Bayesian optimization in Python.
...
- In this course we learn to:
  ...
  - [x] Learn how to optimize hyperparameter tuning, 
  - [x] A/B testing
