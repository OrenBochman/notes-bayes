...
The Raftery and Lewis diagnostic \index{diagnostic!Raftery Lewis} estimates how many iterations of the current chain would be required to reliably estimate the outer quantiles of the posterior.
:::
