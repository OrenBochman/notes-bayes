...
::: {#exr-gs-2}
[Gibbs]{.column-margin} Suppose we have a joint probability distribution for four variables, $p(w,x,y,z)$ . Which of the following expresses the full conditional distribution for variable x?
:::
...
::: {#exr-gs-5}
[Gibbs]{.column-margin} Suppose we have a joint probability distribution for three variables: $p(x,y,z)$ . Identify the algorithm to perform Gibbs sampling for all three variables. 1 point
:::
