...
$$
y_t = \phi y_{t-1} + \varepsilon_t \qquad \varepsilon_t \sim \mathcal{N}(0, v), i.i.d.
$$
...
Interpreted as an infinite-order **Moving Average (MA(∞))** process.
...
### Simulate data from an AR(1) process (video) {#sec-ar1-simulation}
