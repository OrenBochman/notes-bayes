...
![AR(p) process, characteristic polynomial, stability, stationarity and MA representation ](images/m2_0001.png){.column-margin width="250px" group="slides"}
...
![A state space representation of Ar(p)](images/m2_0002.png){.column-margin width="250px" group="slides"}
...
![AR(1)](images/m2_0011.png){.column-margin width="250px" group="slides"}

![AR(2) two positive roots](images/m2_0012.png){.column-margin width="250px" group="slides"}

![AR(2) complex roots](images/m2_0013.png){.column-margin width="250px" group="slides"}

{{< lipsum 3 >}}

## ACF of the AR(p) (video)

![ACF of the AR(p)](images/m2_0021.png){.column-margin width="250px" group="slides"}
