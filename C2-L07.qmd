...
# Linear regression {#c2-l07-linear-regression}

## Introduction to linear regression {#sec-introduction-to-linear-regression}

![Introduction to linear regression](images/c2l07-ss-01-Linear-Regression.png){.column-margin}
...
the ess for sigma is good but for the betas 350 this is too low for estimateing quantiles, it is enough to estimate the mean.
...
5.  $\sigma$ `sig` standard deviation of errors is a determinsitic function of `tau`, and `df`
...
-   Originlay introduced in [@cook1977a] [Cook’s Distance](https://en.wikipedia.org/wiki/Cook%27s_distance) is an estimate of the influence of a data point.
