...
Followin a subjective view of distribution, which is more amenable to reinterpretation I use an indicator function to place restrictions on the range of parameter of the PDF.
...
## Double Exponential Distribution (Laplace) {#sec-double-exponetial}
...
$$f(t\mid\nu)={\frac {1}{{\sqrt {\nu }}\,\mathrm {B} ({\frac {1}{2}},{\frac {\nu }{2}})}}\left(1+{\frac {t^{2}}{\nu }}\right)^{-(\nu +1)/2}\mathbb{I}_{t\in\mathbb{R}} \qquad \text{(PDF)}$$ {#eq-t-pdf-beta}
...
![William Sealy Gosset AKA Student](images/bio-William_Sealy_Gosset.jpg){.column-margin}
