...
2. 
What is the expected value of a random variable X whose distribution is a mixture of Poisson distributions with the form

$$
f(x) = 0.3 \frac{2^x e^{-2}}{x!}  + 0.45 \frac{2^x e^{-3}}{x!} + 0.25 \frac{.5^x e^{-0.5}}{x!}
$$ {#eq-three-component-poisson-mixture}
...
3. What is the variance of a random variable X whose distribution is a mixture of Poisson distributions with the form [@eq-three-component-poisson-mixture] ?
