...
![The Metropolis-Hastings Algorithm](images/c2l04-ss-01-Metropolis-Hastings.png){.column-margin width="200px"}
...
If we use independent M-H, $q(\theta)$ **should be as similar as possible to** $p(\theta)$.
:::
...
![MCMC Coin Flip Example](images/c2l04-ss-02-Monte-Carlo-Demonstration.png){.column-margin width="200px"}
...
![The Metropolis-Hastings Algorithm](images/c2l04-ss-03-Monte-Carlo-Demonstration.png){.column-margin width="200px"}
...
![The Metropolis-Hastings Algorithm](images/c2l04-ss-04-Monte-Carlo-Demonstration.png){.column-margin width="200px"}
...
![state diagram](images/c2l04-states.png){.column-margin width="200px"}
