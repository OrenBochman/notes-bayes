...
## R code: Bayesian inference, AR(p), conditional likelihood (Reading) {#sec-arp-bayesian-inference}
...
### R code: Model order selection (Reading) {#sec-ar-2-model-order-selection} 
