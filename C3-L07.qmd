...
## Mixture Models and Naïve Bayes classifiers 🎥{#sec-mixture-models-naïve-bayes}

![K-means clustering](images/c3l4-ss-04-classification-overview.png){.column-margin width="53mm"}


![K-means clustering](images/c3l4-ss-05-classification-naïve-bayes.png){.column-margin width="53mm"}
