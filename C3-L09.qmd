...
![BIC](images/c3l5-ss-03-BIC.png){#fig-slide03-BIC .column-margin width="200px"}


![BIC](images/c3l5-ss-04-BIC.png){#fig-slide04-BIC .column-margin width="200px"}
...
for(KK in 2:KKmax){ # <10>
  ...
  while(!sw){  # <14>
    ...
    for(k in 1:KK){ # <18>
      for(i in 1:n){ # <19>
        mu[k]    = mu[k] + v[i,k]*x[i] #<20>
      }
      mu[k] = mu[k]/sum(v[,k]) # <21>
    }
...
17. Checking convergence of the EM algorithm
...
![Estimating the number of components](images/c3l5-ss-05-estimating-number-of-components.png){#fig-s05-bayesian-information-criteria-variance .column-margin width="200px"}


![Estimating the number of components](images/c3l5-ss-06-estimating-number-of-components.png){#fig-s06-bayesian-information-criteria-variance .column-margin width="200px"}
