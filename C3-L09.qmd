...
## Bayesian Information Criteria - BIC 🎥 {#sec-BIC} 
...
### Sample code for estimating the number of components and the partition structure in Bayesian models 📖 {#sec-estimating-number-of-components-and-partition-structure}
