...
1. How is Bayesian TS analysis differ from regular TS analysis?
...
1. Will we learn about Gaussian Processes/Neural Networks in this course?
   - This is a type of Bayesian Non-parametric and we don't cover these in the specilization. However Abel Rodriguez, the instructor of the third couse on mixture model has a [short course](https://users.soe.ucsc.edu/~abel/website/Teaching.html) 
...
1. MDM: Multiregression dynamic models
