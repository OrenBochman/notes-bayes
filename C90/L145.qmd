...
description: "In this lesson, we will explore some conditions that can cause a KF to produce unreliable estimates. We will see how the KF performs when the model of the system is incorrect, when the noise covariances are incorrect, and when the noise assumptions are violated."
date: "2026-04-22"
keywords: [Kalman filter, failure modes, model mismatch, noise assumptions]
---
