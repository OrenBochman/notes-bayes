...
$$
\begin{aligned}
X = \begin{bmatrix}X_1 \\ X_2 \\ \vdots \\ X_n\end{bmatrix} \quad \text{and} \quad x_0 = \begin{bmatrix}x_{1} \\ x_{2} \\ \vdots \\ x_{n}\end{bmatrix}
\end{aligned}
$$
...
$$
\begin{aligned}
|\Sigma_{\tilde{X}}| = \text{det}(\Sigma_{\tilde{X}})  \qqad \Sigma_{\tilde{X}}^{-1} \text{requires PSD} \Sigma_{\tilde{X}}
\end{aligned}
$$
