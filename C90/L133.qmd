...
## Overview of vector random (stochastic) processes {#sec-kf-1.3.3-overview-of-vector-random-processes}
...
## Properties and important points {#sec-kf-1.3.3-properties-and-important-points}
...
## White noise {#sec-kf-1.3.3-white-noise}
...
![White noise](images/L.1.3.3-1.png){group="slides"}
:::
...
::: {.column width="45%"}
![Correlated noise](images/L.1.3.3-2.png){group="slides"}
:::
::::

## Shaping filters: Idea {#sec-kf-1.3.3-shaping-filters-idea}
...
![block diagram](images/L.1.3.3-3.png){group="slides"}
...
## Shaping filters: Model {#sec-kf-1.3.3-shaping-filters-model}
...
## Gaussian processes {#sec-kf-1.3.3-gaussian-processes}
