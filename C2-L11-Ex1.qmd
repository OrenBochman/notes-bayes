...
-   [x] $y_i \mid \theta_{g_i}, \sigma^2 \overset{\text{ind}}{\sim} \text{N} ( \theta_{g_i}, \sigma^2)\, , \quad i=1,\ldots,53, \quad g_i \in \{ 1, \ldots, 5 \}, \\ \theta_g \mid \mu, \tau^2 \overset{\text{iid}}{\sim} \text{N}(\mu, \tau^2)\, , \quad g = 1, \ldots, 5, \\ \mu \sim \text{N}(0, 1\mathrm{e}{6})\, , \\ \tau^2 \sim \text{IG}(1/2,\, 1\cdot3/2) \, , \\ \sigma^2 \sim \text{IG}(2/2, \, 2\cdot1/2)$
